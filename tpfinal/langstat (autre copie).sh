...
# $1 (obligatoire) = dico.txt
# $2 (optionnel) = couleur des voyelles ( choix entre bleu, rouge, vert, jaune ou blanc par défaut)
# $3 (optionnel) = couleur des consonnes ( choix entre bleu, rouge, vert, jaune ou blanc par défaut)
